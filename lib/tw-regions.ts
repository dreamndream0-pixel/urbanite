// 台灣縣市 → 行政區(下拉選單用)
export const TW_REGIONS: Record<string, string[]> = {
  ...
  彰化縣: ['彰化市','員林市','和美鎮','鹿港鎮','溪湖鎮','二林鎮','田中鎮','北斗鎮','花壇鄉','芬園鄉','大村鄉','埔鹽鄉','埔心鄉','永靖鄉','社頭鄉','二水鄉','田尾鄉','埤頭鄉','芳苑鄉','大城鄉','竹塘鄉','溪州鄉','伸港鄉','線西鄉','福興鄉','秀水鄉'],
...
export const TW_CITIES = Object.keys(TW_REGIONS);
