  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#fff8f4] px-4 text-[#251b1f]">
      <div className="w-full max-w-md rounded-2xl border border-[#ead8d1] bg-white p-8 shadow-sm">
        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#c84767]">Urbanite</p>
        <h1 className="mt-2 text-3xl font-semibold">登入帳號</h1>
        <p className="mt-2 text-sm text-[#6c565b]">登入後會自動帶你回到剛剛要前往的頁面。</p>
